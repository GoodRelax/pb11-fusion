...
> 詳細: [`two-temp-plasma.md`](two-temp-plasma.md) / [`larmor-radius.md`](larmor-radius.md)
...
**答え:** 🔴 未解決。Rider（1995）の計算ではマクスウェル分布前提で Ti/Te ≈ 300 が必要。4サイクルの2つの抜け道（非マクスウェル分布 + 超短パルス Te 抑制）を組み合わせても Ti/Te ≈ 60〜150 で、300 に届くかは未実証。実験的確認ゼロ。

> 詳細: [`ti-te-escape.md`](ti-te-escape.md) / [`two-temp-plasma.md`](two-temp-plasma.md) / [`fusion-timescales.md`](fusion-timescales.md) / [`larmor-radius.md`](larmor-radius.md)
